const styles = {
    // App.js
    container: "flex-col justify-center min-h-screen bg-zinc-900 font-poppins sm:px-16 px-6 bg-zinc-900",
    innerContainer:
    ...
    exchangeBox:
      "relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full border-2 gradient-border p-[2px] rounded-3xl",
    exchange:
